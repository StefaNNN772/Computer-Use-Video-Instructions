...
```
                                    User Instruction
                                           ...
                                           v
                               +------------------------+
                               |    Input Processor     |  <-- Groq LLM (Llama 3.3 70B)
                               |    (Parse Intent)      |
                               +-----------+------------+
                                           |
                                           v
                               +------------------------+
                               |   Task Decomposer      |  <-- Groq LLM
                               |   (Generate Steps)     |
                               +-----------+------------+
                                           |
                                           v
                               ...
                               +-----------+------------+
                                           ...
                                           v
                               +------------------------+
                               |  Ontology Executor     |  <-- SPARQL Queries
                               | (Read Steps from OWL)  |
                               +-----------+------------+
                                           |
                                           v
                    ...
                    v                      v                      v
          +----------------+    +-------------------+    +------------------+
          | Screen Analyzer|    | Action Performer  |    | Screen Recorder  |
          | (Vision AI)    |    | (PyAutoGUI)       |    | (FFmpeg)         |
          +----------------+    +-------------------+    +------------------+
                    |                      |                      |
                    v                      v                      v
                                  Video Tutorial (MP4)
